...
export declare function openPort(portName: string, baudRate: number, dataBits: number, stopBits: number, parity: number, flowControl: number, rtsEnable?: boolean, dtrEnable?: boolean, discardNull?: boolean): Promise<string>;
